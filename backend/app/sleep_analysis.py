...
Evidence bases:
  - Sleep need: National Sleep Foundation, 7–9 h for adults 18–25 (target anchored at 8 h).
...
def detail() -> dict | None:
    ...
    last14 = dvals[-14:]
    deficit = sum(max(0.0, NEED_HOURS - v) for v in last14)
    surplus = sum(max(0.0, v - NEED_HOURS) for v in last14)
